...
internal class Program
{
  ...
  private static void PrepareForStartBot(ITelegramBotClient bot)
  {
    ...
    var modelsAssemblyPath =
      Path.Combine(baseDirectory, "stanford.nlp.models", "edu.stanford.nlp.corenlp_english_models.dll");
  ...
  private static void StartBot(ITelegramBotClient bot)
  {
    ...
    bot.StartReceiving<BotUpdateHandler>(opts);
  }
}